...
Para integrar MiPOT a tu aplicación se requiere agregar un permiso en la categoría "Information Property List". Para ello:
  ...
  2) Abrir el archivo Info.plist y damos click secundario sobre la categoría "Information Property List" 
  3) Seleccionar opción "Add row" del menú emergente.
  4) Localizar el permiso llamado "Privacy - Camera Usage Description" y seleccionarlo.
